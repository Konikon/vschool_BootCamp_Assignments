...
class Player {
    constructor(name, totalCoins, status, star, setName, gotHit, gotPowerUp, gameActive, addCoin, print){
    this.name = "";
    this.totalCoins = ;
    this.status = "";
    this.star = true;
    ...
    setName(namePicked){
        if(namePicked === "Mario") setName = "Mario";
        else(namePicked === "Luigi") setname = "Luigi";
    }
